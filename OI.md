...
> **🤖 For AI Agents:** If you're an AI agent installing this server in OI OS / Brain Trust 4, see [OI.md](./OI.md) for complete installation instructions, parameter extractors, and intent mappings setup.
